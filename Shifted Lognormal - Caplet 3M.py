#Calibration of a shifted lognormal model
#3M caplet smile with expiry one year (fixing in 1 year and payment in 1.25 years)
#Forward rate = 4%, discount rate r = 4%
#Implied volatilities of the 4% and 3.75% strikes be 20% and 20.25% respectively
